...
@endsection
@section('content')
    <form class="form" action="{{ route('admin.students.update') }}" method="POST" id="form_students_update">
        @csrf
        <!--begin::Subheader-->
            ...
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.students.edit', $student->id) }}" class="text-muted">
                                {{ __('students.student_update') }}
                            </a>
                        </li>
                    </ul>
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="my-5">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="image-input image-input-outline"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style="background-image: url({{ asset('/adminBoard/uploadedImages/students/' . $student->photo) }}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input value="{{ $student->name_ar }}"
                                                                class="form-control form-control-solid form-control-lg"
                                                                name="name_ar" id="name_ar" type="text"
                                                                placeholder=" {{ __('students.enter_name_ar') }}"
                                                                autocomplete="off" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input value="{{ $student->name_en }}"
                                                                class="form-control form-control-solid form-control-lg"
                                                                name="name_en" id="name_en" type="text"
                                                                placeholder=" {{ __('students.enter_name_en') }}"
                                                                autocomplete="off" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input value="{{ $student->mobile }}"
                                                                class="form-control form-control-solid form-control-lg"
                                                                name="mobile" id="mobile" type="text"
                                                                placeholder=" {{ __('students.enter_mobile') }}"
                                                                autocomplete="off" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input value="{!! $student->email !!}"
                                                                ...
                                                                placeholder=" {{ __('students.enter_email') }}"
                                                                autocomplete="off" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input value="{!! $student->whatsapp !!}"
                                                                class="form-control form-control-solid form-control-lg"
                                                                name="whatsapp" id="whatsapp" type="text"
                                                                placeholder=" {{ __('students.enter_whatsapp') }}"
                                                                autocomplete="off" />
                                                            <span class="form-text text-danger"
