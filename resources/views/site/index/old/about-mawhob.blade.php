        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-lg-5">
                <div class="box-video-right" data-aos="fade-left" data-aos-duration="1800"
                     @if(aboutMawob()->about_mwhob_image == null)
                     style="background-image: url({!! asset('site/img/video.jpeg') !!});"
                     @else
                     style="background-image: url({!! asset(Storage::url(aboutMawob()->about_mwhob_image)) !!});"
                    @endif
                >
