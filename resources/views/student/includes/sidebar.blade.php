<div class="col-lg-3">
    <div class="left-list-cp">
            ...
            <div class="list-contact-icons">
                <ul>
                    ...
                    <li>
                        ...
                        <span class="text">{!! student()->user()->mobile !!}</span>
                    </li>
                    <li>
                        <span class="icon"><i class="fab fa-whatsapp"></i></span>
                        <span class="text">{!! student()->user()->whatsapp !!}</span>
                    </li>
                    <li>
        ...
        <div class="list-links-pages p-4 bg-light">
            <ul>
                <li>
                    <a href="{!! route('student.portfolio') !!}" class="@if (str_contains(url()->current(), 'portfolio')) active @endif">
                        <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="30.517" height="25.5"
                                viewBox="0 0 30.517 25.5">
                                <defs>
                                    <style>
                                        .a {
                                            fill: #f28705;
                                ...
                                <g transform="translate(0.299 -1.75)">
                                    <g transform="translate(0.007 5.745)">
                                        <path class="a"
                                    ...
                                    <g transform="translate(-0.027 10.707)">
                                        <path class="a"
                                            ...
                                            transform="translate(0.027 -8.962)" />
                                    </g>
                                </g>
                            </svg></span>
                ...
                <li>
                    <a href="{!! route('student.courses') !!}" class="@if (str_contains(url()->current(), 'courses')) active @endif">
                ...
                <li>
                    <a href="{!! route('student.update.account') !!}" class="@if (str_contains(url()->current(), 'update-account')) active @endif">
                        <span class="icon">
