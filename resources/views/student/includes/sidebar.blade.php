    ...
    <div class="left-list-cp" id="student_profile_photo">
        ...
        <div class="list-links-pages p-4 bg-light">
            <ul>
                ...
                <li>
                    <a href="{!! route('student.courses') !!}" class="@if (str_contains(url()->current(), 'courses') || str_contains(url()->current(), 'course')) active @endif">
                ...
                <li>
                    <a href="{!! route('student.notifications') !!}" class="@if (str_contains(url()->current(), 'notifications')) active @endif">
                        <span class="icon">
