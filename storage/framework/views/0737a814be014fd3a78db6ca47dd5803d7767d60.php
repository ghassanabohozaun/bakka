                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item">
                                <a href="<?php echo route('admin.students'); ?>" class="text-muted">
                                    <?php echo e(trans('menu.students')); ?>

                                </a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="" class="text-muted">
                                    <?php echo e(trans('students.profile')); ?>
                                ...
                                <div class="d-flex align-items-center" style="margin-top: 40px">
                                    <div
                                        ...
                                        <?php if(!$student->photo): ?>
                                            <?php if($student->gender == trans('general.male')): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <div class="symbol-label" style="background-image:url(<?php echo \Illuminate\Support\Facades\Storage::url($student->photo); ?>)">
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted" style="font-weight: 600;font-size: 12px">
                                            <?php if($student->freeze == 'on'): ?>
                                                <span class="text-success"><?php echo __('students.activited'); ?></span>
                                            <?php else: ?>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark"><?php echo trans('students.enrolled_courses'); ?></span>
                                </h3>
                            </div>
                            <!--end::Header-->
                                            ...
                                            <?php else: ?>
                                                <table class="table" style="text-align: center;vertical-align: middle;">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">#</th>
                                                            <th scope="col"><?php echo trans('courses.title_ar'); ?></th>
                                                            <th scope="col"><?php echo trans('courses.title_en'); ?></th>
                                                            <th scope="col"><?php echo trans('courses.hours'); ?></th>
                                                            <th scope="col"><?php echo trans('courses.cost'); ?></th>
                                                            <th scope="col"><?php echo trans('courses.discount'); ?></th>
                                                            <th scope="col"><?php echo trans('courses.date'); ?></th>
