<div class="col-lg-3">
    <div class="left-list-cp" id="student_profile_photo">
        ...
        <div class="list-links-pages p-4 bg-light">
            <ul>
                <li>
                    <a href="<?php echo route('student.portfolio'); ?>" class="<?php if(str_contains(url()->current(), 'portfolio')): ?> active <?php endif; ?>">
                        ...
                        <span class="title"><?php echo trans('site.portfolio'); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo route('student.courses'); ?>" class="<?php if(str_contains(url()->current(), 'courses')): ?> active <?php endif; ?>">
                ...
                <li>
                    <a href="<?php echo route('student.update.account'); ?>" class="<?php if(str_contains(url()->current(), 'update-account')): ?> active <?php endif; ?>">
                        ...
                        <span class="title">
                            <?php echo trans('site.update_account'); ?>
