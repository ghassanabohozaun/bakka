    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('courses.add_new_student')); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>

            <form action="<?php echo route('admin.course.enroll.student.store'); ?>" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-4 col-lg-4 col-form-label">
                                            <?php echo e(__('courses.student_name')); ?>
...
<?php $__env->startPush('js'); ?>
    <script type="text/javascript">
        ...
        $('#student_id_select2').select2({
            ...
            placeholder: '<?php echo __('general.select_from_list'); ?>',
            allowClear: true,
            ...
            ajax: {
                url: "<?php echo route('admin.get.all.students.name'); ?>",
                dataType: 'json',
                delay: 10,
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\bakka\resources\views/admin/courses/enroll-list/modals/add-new-student.blade.php ENDPATH**/ ?>