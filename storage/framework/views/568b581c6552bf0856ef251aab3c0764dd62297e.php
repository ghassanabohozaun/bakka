...
<?php $__env->startSection('content'); ?>
    <form class="form" action="<?php echo e(route('admin.courses.store')); ?>" method="POST" id="courses_add_form">
        <?php echo csrf_field(); ?>
        <!--begin::Subheader-->
            ...
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.courses.create')); ?>" class="text-muted">
                                                ...
                                                <div class="my-5">
                                                    ...
                                                    <div class="form-group row d-none">
                                                        <input type="hidden" class="form-control" id='site_lang_en'
                                                            name="site_lang_en" value="<?php echo setting()->site_lang_en; ?>">
                                                    </div>
                                                    <!--end::Group-->
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5" class="form-control form-control-solid form-control-lg" name="description_ar"
                                                                id="description_ar" type="text" placeholder=" <?php echo e(__('courses.enter_description_ar')); ?>" autocomplete="off"></textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5" class="form-control form-control-solid form-control-lg" name="description_en"
                                                                id="description_en" type="text" placeholder=" <?php echo e(__('courses.enter_description_en')); ?>" autocomplete="off"></textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="3" class="form-control form-control-solid form-control-lg" name="zoom_link" id="zoom_link"
                                                                type="text" placeholder=" <?php echo e(trans('courses.enter_zoom_link')); ?>" autocomplete="off"></textarea>
                                                            <span class="form-text text-danger"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/courses/create.blade.php ENDPATH**/ ?>