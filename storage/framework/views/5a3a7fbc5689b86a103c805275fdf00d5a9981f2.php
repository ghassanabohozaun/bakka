...
<?php $__env->startSection('content'); ?>
    <form class="form" action="<?php echo e(route('admin.photo.albums.update')); ?>" method="POST" id="form_photo_album_update">
        <?php echo csrf_field(); ?>
        <!--begin::Subheader-->
            ...
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.photo.albums.edit', $photoAlbum->id)); ?>" class="text-muted">
                                <?php echo e(__('photoAlbums.photo_album_update')); ?>
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="my-5">
                                                    ...
                                                    <div class="d-none form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                value="<?php echo e($photoAlbum->id); ?>" />
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">
                                                            <?php echo e(__('photoAlbums.main_photo')); ?>
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="image-input image-input-outline"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style=";background-image: url(<?php echo e(asset('adminBoard/uploadedImages/albums/' . $photoAlbum->main_photo)); ?>">
                                                                </div>
                                                                <label
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">
                                                            <?php echo e(__('photoAlbums.title_en')); ?>

                                                        </label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="3" class="form-control form-control-solid form-control-lg" name="title_en" id="title_en"
                                                                type="text" placeholder=" <?php echo e(__('photoAlbums.enter_title_en')); ?>" autocomplete="off"><?php echo e($photoAlbum->title_en); ?></textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">
                                                            <?php echo e(__('photoAlbums.title_ar')); ?>

                                                        </label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="3" class="form-control form-control-solid form-control-lg" name="title_ar" id="title_ar"
                                                                type="text" placeholder=" <?php echo e(__('photoAlbums.enter_title_ar')); ?>" autocomplete="off"><?php echo e($photoAlbum->title_ar); ?></textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">
                                                            <?php echo e(__('photoAlbums.year')); ?>
                                                            ...
                                                            <select class="form-control  form-control-lg" name="year"
                                                                ...
                                                                <?php for($year = $firstYear; $year <= $lastYear; $year++): ?>
                                                                    <option value="<?php echo e($year); ?>"
                                                                        <?php echo e($photoAlbum->year == $year ? 'selected' : ''); ?>>
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        ...
                        $('.add_photo_button').click(function() {
                            window.location.href = "<?php echo e(route('admin.photo.albums')); ?>";
                        });
                    }
                }, //end success
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/photo-albums/update.blade.php ENDPATH**/ ?>