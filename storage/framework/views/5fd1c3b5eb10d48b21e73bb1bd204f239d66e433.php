    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('courses.add_certification')); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>

            <form action="<?php echo route('admin.student.certifications.store'); ?>" method="POST" enctype="multipart/form-data"
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\bakka\resources\views/admin/courses/enroll-list/modals/add-student-certification.blade.php ENDPATH**/ ?>