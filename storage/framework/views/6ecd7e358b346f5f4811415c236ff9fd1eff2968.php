                            ...
                            <div class="p-5 text-center sigin_up_section">
                                ...
                                <form action="<?php echo route('student.signup.store'); ?>" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group text-left">
                                        <label for="nPassword"><?php echo __('students.password'); ?>.</label>
                                        <input type="password" class="form-control" id="password" name="password"
                                            autocomplete="off" placeholder="<?php echo __('students.enter_password'); ?>">
                                    </div>

                                    <div class="form-group text-left">
                                        <label for="cnPassword"><?php echo __('students.confirm_password'); ?>.</label>
                                        <input type="password" class="form-control" id="confirm_password"
                                            name="confirm_password" autocomplete="off"
                                            placeholder="<?php echo __('students.enter_confirm_password'); ?>">
                                    </div>
                                    ...
                                    <div class="form-group text-left">
                                        <label for="gender"><?php echo __('students.gender'); ?>.</label>
    ...
    <script type="text/javascript">
        $('#student_signup_form').validate({
            ...
            messages: {
                ...
                mobile: {
                    required: '<?php echo e(__('site.it_is_required')); ?>',
                    digits: '<?php echo e(__('site.digits')); ?>',
                    minlength: '<?php echo e(__('site.mobile_number_validation')); ?>',
                    maxlength: '<?php echo e(__('site.mobile_number_validation')); ?>',
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        ...
                        Swal.fire({
                            ...
                            cancelButtonText: `<?php echo __('site.cancel'); ?>`,
                            confirmButtonText: `<?php echo __('site.login'); ?>`,
                            customClass: {
