...
<?php $__env->startSection('content'); ?>
    <form class="form" action="<?php echo e(route('admin.faqs.update')); ?>" method="POST" id="form_faq_update"
                        ...
                        <div class="card card-custom" id="card_languages">
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-5">
                                    <?php echo $__env->make('admin.faq.update_tabs.details_ar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php if(setting()->site_lang_ar == 'on'): ?>
                                        <?php echo $__env->make('admin.faq.update_tabs.details_en', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/faq/update.blade.php ENDPATH**/ ?>