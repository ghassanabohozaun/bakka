        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('supportCenter.show_message')); ?></h5>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                <?php echo e(__('supportCenter.title')); ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                <?php echo e(__('supportCenter.message')); ?>
...
<?php /**PATH C:\laragon\www\bakka\resources\views/admin/support-center/show_message_modal.blade.php ENDPATH**/ ?>