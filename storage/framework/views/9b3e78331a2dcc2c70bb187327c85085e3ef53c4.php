                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                name="question_ar" id="question_ar" placeholder="<?php echo e(__('faqs.enter_question_ar')); ?>"
                                autocomplete="off">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\bakka\resources\views/admin/faq/create_tabs/details_ar.blade.php ENDPATH**/ ?>