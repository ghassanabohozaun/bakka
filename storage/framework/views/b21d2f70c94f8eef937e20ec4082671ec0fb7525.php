...
<?php $__env->startSection('content'); ?>
    <form class="form" action="<?php echo e(route('admin.services.update')); ?>" method="POST" id="services_update_from"
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.services')); ?>" class="text-muted">
                        ...
                        <div class="card card-custom" id="card_languages">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="settings_tab" data-toggle="tab" href="#settings">
                                            ...
                                            <span class="nav-text"><?php echo e(__('services.settings_tab')); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="details_en_tab" data-toggle="tab"
                                            ...
                                            <span class="nav-text"><?php echo e(__('services.details_en_tab')); ?></span>
                                        </a>
                                    </li>
                                    <?php if(setting()->site_lang_ar == 'on'): ?>
                                        <li class="nav-item">
                                            <a class="nav-link" id="details_ar_tab" data-toggle="tab"
                                                ...
                                                <span class="nav-icon"><i class="flaticon2-layers-2"></i></span>
                                                <span class="nav-text"><?php echo e(__('services.details_ar_tab')); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <div class="tab-content mt-5">
                                    <?php echo $__env->make('admin.services.update_tabs.settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php echo $__env->make('admin.services.update_tabs.details_en', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php if(setting()->site_lang_ar == 'on'): ?>
                                        <?php echo $__env->make('admin.services.update_tabs.details_ar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?>
                                </div>
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        ...
                        $('.update_service_button').click(function() {
                            window.location.href = "<?php echo e(route('admin.services')); ?>";
                        });
                    }
                }, //end success
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/services/update.blade.php ENDPATH**/ ?>