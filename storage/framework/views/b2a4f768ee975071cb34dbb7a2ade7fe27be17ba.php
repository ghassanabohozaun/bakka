...
<?php $__env->startSection('content'); ?>
    ...
    <form class="form" action="<?php echo route('admin.role.update'); ?>" method="POST" id="form_role_update">
        <?php echo csrf_field(); ?>
        <!--begin::Subheader-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">
                                <?php echo e(__('roles.update_permission')); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input
                                                                ...
                                                                value="<?php echo e($role->role_name_ar); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input
                                                                ...
                                                                value="<?php echo e($role->role_name_en); ?>"
                                                                ...
                                                                <div class="checkbox-inline" style="margin-top: 5px">
                                                                    <label class="checkbox checkbox-primary">
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            <?php echo e(in_array($name,$role->permissions) ? 'checked' : ''); ?>>
                                                                        <span></span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/roles/update.blade.php ENDPATH**/ ?>