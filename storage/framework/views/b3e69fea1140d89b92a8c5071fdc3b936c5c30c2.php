                ...
                <div class="col-xl-9">
                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            <label><?php echo e(__('articles.title_en')); ?></label>
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                   name="title_en" id="title_en"
                                   placeholder="<?php echo e(__('articles.enter_title_en')); ?>"
                                   autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-solid form-control-lg summernote"
                                      placeholder="<?php echo e(__('articles.enter_abstract_en')); ?>"
...
<?php /**PATH C:\laragon\www\bakka\resources\views/admin/articles/create_tabs/details_en.blade.php ENDPATH**/ ?>