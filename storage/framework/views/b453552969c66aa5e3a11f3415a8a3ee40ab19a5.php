...
<?php $__env->startSection('content'); ?>
    <form class="form" action="<?php echo e(route('admin.photo.albums.store')); ?>" method="POST" id="form_photo_album_add">
        <?php echo csrf_field(); ?>
        <!--begin::Subheader-->
            ...
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.photo.albums.create')); ?>" class="text-muted">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="3" class="form-control form-control-solid form-control-lg" name="title_en" id="title_en"
                                                                type="text" placeholder=" <?php echo e(__('photoAlbums.enter_title_en')); ?>" autocomplete="off"></textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="3" class="form-control form-control-solid form-control-lg" name="title_ar" id="title_ar"
                                                                type="text" placeholder=" <?php echo e(__('photoAlbums.enter_title_ar')); ?>" autocomplete="off"></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/photo-albums/create.blade.php ENDPATH**/ ?>