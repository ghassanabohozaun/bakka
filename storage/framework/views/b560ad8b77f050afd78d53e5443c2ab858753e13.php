...
<a href="#" title="<?php echo __('supportCenter.mark_as_contacted'); ?>"
   class="btn btn-info btn-icon btn-pill  btn-sm mr-3   <?php echo $supportCenter->status=='contacted' ?'disabled':''; ?>
...
<a href="#" title="<?php echo __('supportCenter.mark_as_solved'); ?>"
   class="btn btn-success btn-icon btn-pill btn-sm mr-3
<?php echo $supportCenter->status=='solved' ?'disabled':''; ?>  support_center_message_status_solved_btn" data-id="<?php echo e($supportCenter->id); ?>">
...
<?php /**PATH C:\laragon\www\bakka\resources\views/admin/support-center/parts/options.blade.php ENDPATH**/ ?>