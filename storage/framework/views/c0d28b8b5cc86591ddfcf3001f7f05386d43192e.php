...
<?php $__env->startSection('content'); ?>
    <form class="form" action="<?php echo e(route('admin.sliders.store')); ?>" method="POST" id="sliders_add_form">
        <?php echo csrf_field(); ?>
        <!--begin::Subheader-->
            ...
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.sliders.create')); ?>" class="text-muted">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5" class="form-control form-control-solid form-control-lg" name="details_ar" id="details_ar"
                                                                type="text" placeholder=" <?php echo e(__('sliders.enter_details_ar')); ?>" autocomplete="off"></textarea>
                                                            <span class="form-text text-danger"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5" class="form-control form-control-solid form-control-lg" name="details_en" id="details_en"
                                                                type="text" placeholder=" <?php echo e(__('sliders.enter_details_en')); ?>" autocomplete="off"></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/landing-page/sliders/create.blade.php ENDPATH**/ ?>