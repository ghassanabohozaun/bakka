    ...
    <div style="margin-top:18px" id="kt_aside_menu" class="aside-menu " data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav ">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('students')): ?>
                <li class="menu-item  menu-item-submenu
                   <?php if(str_contains(url()->current(), '/students')): ?> menu-item-open <?php endif; ?>"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="<?php echo route('admin.students'); ?>" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text"><?php echo e(__('menu.students')); ?></span>
                        <span class="menu-label">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('courses')): ?>
                <li class="menu-item  menu-item-submenu
                   <?php if(str_contains(url()->current(), '/courses')): ?> menu-item-open <?php endif; ?>"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="<?php echo route('admin.courses'); ?>" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text"><?php echo e(__('menu.courses')); ?></span>
                        <span class="menu-label">
                            <span class="label label-rounded label-danger">
...
<?php /**PATH C:\laragon\www\bakka\resources\views/admin/includes/menu.blade.php ENDPATH**/ ?>