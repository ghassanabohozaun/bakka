                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#" class="text-muted">
                            <?php echo e(__('menu.trashed_courses')); ?>

                        </a>
                    </li>

                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('admin.courses.trashed')); ?>" class="text-muted">
...
<?php $__env->startPush('js'); ?>
    <script type="text/javascript">
        ...
        $(document).on('click', '.force_delete_course_btn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: '<?php echo route('admin.courses.force.delete'); ?>',
                        data: {
                            id,
                            id
                        },
        ...
        $(document).on('click', '.restore_course_btn', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.courses.restore')); ?>",
                data: {
                    id,
                    id
                },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/courses/trashed.blade.php ENDPATH**/ ?>