...
<?php $__env->startSection('content'); ?>
    <form class="form" action="<?php echo e(route('admin.testimonial.update')); ?>" method="POST" id="form_opinions_update">
        <?php echo csrf_field(); ?>
        <!--begin::Subheader-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">
                                <?php echo e(__('testimonials.update_testimonial')); ?>
                                                    ...
                                                    <div class="d-none form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                value="<?php echo e($testimonial->id); ?>" />
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="image-input image-input-outline"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style="background-image: url(<?php echo e(asset('adminBoard/uploadedImages/testimonials/' . $testimonial->photo)); ?>)">
                                                                </div>
                                                                <label
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                autocomplete="off" value="<?php echo e($testimonial->name_ar); ?>" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                autocomplete="off" value="<?php echo e($testimonial->name_en); ?>" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                value="<?php echo e($testimonial->age); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                <option value="male"
                                                                    <?php echo e($testimonial->gender == 'male' ? 'selected' : ''); ?>>
                                                                    <?php echo e(__('testimonials.male')); ?>

                                                                </option>
                                                                <option value="female"
                                                                    <?php echo e($testimonial->gender == 'female' ? 'selected' : ''); ?>>
                                                            ...
                                                            <select class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                <?php $__currentLoopData = \App\Models\Country::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($country->id); ?>"
                                                                        <?php echo e($country->id == $testimonial->country ? 'selected' : ''); ?>>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                autocomplete="off"
                                                                value="<?php echo e($testimonial->job_title_ar); ?>" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                autocomplete="off"
                                                                value="<?php echo e($testimonial->job_title_en); ?>" />
                                                            <span class="form-text text-danger"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                <option value="1"
                                                                    <?php echo e($testimonial->rating == '1' ? 'selected' : ''); ?>>
                                                                    <?php echo e(__('testimonials.one_star')); ?>

                                                                </option>

                                                                <option value="2"
                                                                    <?php echo e($testimonial->rating == '2' ? 'selected' : ''); ?>>
                                                                    <?php echo e(__('testimonials.two_star')); ?>

                                                                </option>
                                                                <option value="3"
                                                                    <?php echo e($testimonial->rating == '3' ? 'selected' : ''); ?>>
                                                                    <?php echo e(__('testimonials.three_star')); ?>

                                                                </option>
                                                                <option value="4"
                                                                    <?php echo e($testimonial->rating == '4' ? 'selected' : ''); ?>>
                                                                    <?php echo e(__('testimonials.four_star')); ?>

                                                                </option>
                                                                <option value="5"
                                                                    <?php echo e($testimonial->rating == '5' ? 'selected' : ''); ?>>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="10" class="form-control form-control-solid form-control-lg" name="opinion_ar" id="opinion_ar"
                                                                type="text" placeholder=" <?php echo e(__('testimonials.enter_opinion_ar')); ?>" autocomplete="off"><?php echo e($testimonial->opinion_ar); ?></textarea>
                                                            <span class="form-text text-danger"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="10" class="form-control form-control-solid form-control-lg" name="opinion_en" id="opinion_en"
                                                                type="text" placeholder=" <?php echo e(__('testimonials.enter_opinion_en')); ?>" autocomplete="off"><?php echo e($testimonial->opinion_en); ?></textarea>
                                                            <span class="form-text text-danger"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/testimonials/update.blade.php ENDPATH**/ ?>