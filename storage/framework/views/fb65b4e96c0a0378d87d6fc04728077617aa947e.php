                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#" class="text-muted">
                            <?php echo e(__('menu.trashed_students')); ?>

                        </a>
                    </li>

                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('admin.students.trashed')); ?>" class="text-muted">
...
<?php $__env->startPush('js'); ?>
    <script type="text/javascript">
        ...
        $(document).on('click', '.force_delete_student_btn', function(e) {
            ...
            Swal.fire({
                title: "<?php echo e(__('general.ask_permanent_delete_record')); ?>",
                icon: "warning",
                ...
                if (result.value) {
                    ...
                    // Delete stident
                    $.ajax({
                        url: '<?php echo route('admin.students.force.delete'); ?>',
                        data: {
                            id,
                            id
                        },
                    ...
                    Swal.fire({
                        ...
                        text: "<?php echo __('general.error_message'); ?>",
                        icon: "error",
                        allowOutsideClick: false,
                        customClass: {
        ...
        $(document).on('click', '.restore_student_btn', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.students.restore')); ?>",
                data: {
                    id,
                    id
                },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bakka\resources\views/admin/students/trashed.blade.php ENDPATH**/ ?>